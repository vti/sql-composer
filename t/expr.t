...
subtest 'build raw' => sub {
    my $expr = SQL::Builder::Expression->new('a = b');
...
subtest 'build as is with bind' => sub {
    my $expr =
      SQL::Builder::Expression->new(a => {'>' => \['length(?)' => 'hi']});
...
subtest 'build as is on the left' => sub {
    my $expr = SQL::Builder::Expression->new(\'1' => 1);
...
subtest 'build as is with bind on the left' => sub {
    my $expr = SQL::Builder::Expression->new(\['length(?)', 5] => 1);
...
subtest 'build in' => sub {
    my $expr = SQL::Builder::Expression->new(a => ['b', 'c', 'd']);
...
subtest 'build OR' => sub {
    my $expr = SQL::Builder::Expression->new(-or => [a => 'b', c => 'd']);
